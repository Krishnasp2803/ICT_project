...
import "../styles/food.css"; // Import your CSS file
      ...
      <center>
        ...
        <div className="firstdiv">
          ...
          <div className="subdiv1">
            ...
            <a href="exhibition.html" className="glass-button">Exhibitions</a>
          </div>

          {/* City Selector */}
          <div className="subdiv2">
            <h2>Select a City for Food Fests</h2>
